...
func (a *AssertionHelper) AssertWagerResolved(result *entities.GroupWagerResult, expectedWinnerCount, expectedLoserCount int) {
	require.NotNil(a.t, result)
	assert.Equal(a.t, entities.GroupWagerStateResolved, result.GroupWager.State)
...
func (a *AssertionHelper) AssertPayouts(result *entities.GroupWagerResult, expectedPayouts map[int64]int64) {
...
func (a *AssertionHelper) AssertPoolWagerPayouts(result *entities.GroupWagerResult) {
...
func (a *AssertionHelper) AssertHouseWagerPayouts(result *entities.GroupWagerResult, winningOption *entities.GroupWagerOption) {
...
func (a *AssertionHelper) AssertBalanceChanges(wagerType entities.GroupWagerType, winners, losers []*entities.GroupWagerParticipant) {
	if wagerType == entities.GroupWagerTypePool {
...
func (a *AssertionHelper) AssertParticipantPayout(participant *entities.GroupWagerParticipant, expectedPayout int64, hasBalanceHistory bool) {
...
func (a *AssertionHelper) AssertWagerState(wager *entities.GroupWager, expectedState entities.GroupWagerState) {
...
func (a *AssertionHelper) AssertGroupWagerCreated(result *entities.GroupWagerDetail, wagerType entities.GroupWagerType, optionCount int) {
	require.NotNil(a.t, result)
	require.NotNil(a.t, result.Wager)
	assert.Equal(a.t, wagerType, result.Wager.WagerType)
	assert.Equal(a.t, entities.GroupWagerStateActive, result.Wager.State)
	assert.Len(a.t, result.Options, optionCount)
	assert.Empty(a.t, result.Participants)
}

// AssertOptionOdds verifies option odds
func (a *AssertionHelper) AssertOptionOdds(options []*entities.GroupWagerOption, expectedOdds map[int]float64) {
