...
from lol_tracker.database.connection import DatabaseManager, initialize_database, close_database, get_database_manager
...
class TestDatabaseManager:
    ...
    async def test_repository_integration(self, db_manager: DatabaseManager):
        ...
        async with db_manager.get_session() as session:
            ...
            deleted_player = await player_repo.get_by_summoner_and_region("IntegrationTest", "NA1")
