...
type GroupWagerService interface {
	...
	CreateGroupWager(ctx context.Context, creatorID int64, condition string, options []string, votingPeriodHours int, messageID, channelID int64) (*models.GroupWagerDetail, error)
